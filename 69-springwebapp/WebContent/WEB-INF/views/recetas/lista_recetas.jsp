                            ...
                            <table id="mitabla" class="table table-striped table-bordered table-hover">
                                <thead>
                                  <tr>
                                    ...
                                    <th class=" btn-link">Ingredientes</th>
                                    <th class=" btn-link"><i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>Tiempos</th>
                                    <th class=" btn-link">Explicacion</th>
								...
								<c:forEach items="${recetas}" var="receta">
                                  <tr>
                                    ...
                                    <td><c:out value="${receta.ingredientes}" /></td>
                                    <td><c:out value="${receta.tiempos}" /></td>
                                    <td><c:out value="${receta.explicacion}" /></td>
                                    <td> 

                                        <div class="hidden-sm hidden-xs btn-group">
											<a href='<c:url value="/receta/${receta.id}/edit" />'>
											 <button class="btn btn-xs btn-info" id="editar">
                                                <i class="ace-icon fa fa-pencil bigger-120"></i>
                                            </button>
											
											Editar</a>
											<a href='<c:url value="/receta/${receta.id}/delete" />'>Borrar
                                                         <button class="btn btn-xs btn-danger" id="borrar" onclick="'.$fraseconfirmacion.'">
