...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Acceso al Panel de administracion</title>
		...
		<!--[if lte IE 9]>
			<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/admin/assets/css/ace-part2.css" />
		<![endif]-->

		<!--[if lte IE 9]>
		  <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/admin/assets/css/ace-ie.css" />
		<![endif]-->
		...
		<script src="${pageContext.request.contextPath}/resources/admin/assets/js/respond.js"></script>
		<![endif]-->
	</head>
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">ADMINISTRACIÓN AMÉRICA</span>
										...
										<div class="widget-main">
											...
											<form name='f' action="j_spring_security_check" method='POST'>
												<fieldset>
													...
													<div class="clearfix">
														<label class="inline">
															<input type='checkbox' class="ace" name='_spring_security_remember_me' checked="checked" />
