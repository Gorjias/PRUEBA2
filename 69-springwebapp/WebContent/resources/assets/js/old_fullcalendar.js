...
var defaults = {
	...
	// FORMA DE MOSTRAR EL CALENDARIO EN MODO MES
	defaultView: 'month',
	aspectRatio: 1.35,
	header: {
		left: 'title',
...
function Calendar(element, instanceOptions) {
	...
	function getLocaleData(langCode) {
		...
		return f.call(moment, langCode) ||
			f.call(moment, 'es'); // the newer localData could return null, so fall back to en
	}
			...
			$.each(buttonStr.split(' '), function(i) {
				...
				$.each(this.split(','), function(j, buttonName) {
					...
					if (buttonName == 'title') {
						...
						else if (fcViews[buttonName]) { // SI NOMBRE VISTA, CAMBIA A TIPO VIST.EL VALUE DEL BOTONY EL CHANGE VIEW COINCIDE 
							buttonClick = function() {
...
/*  FUNCION CON VISTA MENSUAL VERTICAL
---------------------------------------------------------------------------------------------------------------------*/
...
/* FUNCION CON VISTA SEMANAL VERTICAL
----------------------------------------------------------------------------------------------------------------------*/
...
/* FUNCION CON VISTA DIARIA VERTICAL
----------------------------------------------------------------------------------------------------------------------*/
